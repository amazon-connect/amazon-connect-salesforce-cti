...
- **Bug Fix:** Fixed the issue that prevented the use of custom Named Credentials names with recording controls, as part of the enhancements introduced in v5.22 ([link to documentation](cti-adapter/09-recording-controls/#cti-adapter-named-credential-location)).
