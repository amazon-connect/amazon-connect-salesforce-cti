...
10. **Audio Device Settings** Turning this setting on allows the Agent 
    ...
    You may have to add this field to the layout manually. [See troubleshooting](/docs/classic/02-installation/04-cti-adapter-installation-troubleshooting).
...
11. **Phone Type Settings** Turning this setting on allows the Agent to 
    ...
    the layout manually. [See troubleshooting](/docs/classic/02-installation/04-cti-adapter-installation-troubleshooting)
...
Sign On, please follow the setup instructions in [Appendix B - Configuring Salesforce as Your Identity Provider](/docs/classic/05-appendices/02-appendix-b-configuring-salesforce-as-your-identity-provider/01-configuring-salesforce-as-your-identity-provider).
